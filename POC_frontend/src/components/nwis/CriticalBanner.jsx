...
export const CriticalBanner = ({ show, risk, depth, onViewCase, onAck }) => (
  <AnimatePresence>
    {show && (
      ...
      >
        <div className="glass border border-nw-crit/70 rounded-xl px-4 sm:px-5 py-4 flex flex-col sm:flex-row sm:items-center gap-4" style={{ boxShadow: "0 0 50px -8px rgba(239,68,68,.55), inset 0 1px 0 rgba(255,255,255,.04)" }}>
          ...
          <div className="flex-1 min-w-0">
            <div className="font-display font-semibold tracking-[0.12em] text-nw-crit text-[13px] uppercase" data-testid="critical-banner-title">
          ...
          <div className="flex gap-2 sm:gap-3 shrink-0">
            <button className="btn btn-danger flex-1 sm:flex-none justify-center" onClick={onViewCase} data-testid="critical-banner-view-case-button">
              <FileSearch className="w-3.5 h-3.5" /> Case file
            </button>
            <button className="btn flex-1 sm:flex-none justify-center" onClick={onAck} data-testid="critical-banner-acknowledge-button">
